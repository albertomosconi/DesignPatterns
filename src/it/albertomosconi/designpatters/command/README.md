# Command Pattern
source: [wikipedia](https://en.wikipedia.org/wiki/Command_pattern "wikipedia")
...
## UML
![UML Diagram](https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Command_pattern.svg/1920px-Command_pattern.svg.png)