# Facade Pattern
source: [wikipedia](https://en.wikipedia.org/wiki/Facade_pattern "wikipedia")
...
## UML
![UML Diagram](https://upload.wikimedia.org/wikipedia/en/5/57/Example_of_Facade_design_pattern_in_UML.png)