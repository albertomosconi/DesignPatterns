# Observer Pattern
source: [wikipedia](https://en.wikipedia.org/wiki/Observer_pattern "wikipedia")
...
## UML
![UML diagram](https://upload.wikimedia.org/wikipedia/commons/0/01/W3sDesign_Observer_Design_Pattern_UML.jpg)